        ...
        <div className={classes.pageContainer}>
            ...
            <div className={classes.container}>
                <Grid2 container columns={2}  >
                    <Grid2 style={{ width: "45%" }} xl={1}>
                        <h3>Zakladní informace</h3>
                        <div>
                            <div style={{ margin: "0.5vw" }}>
                                Nadpis:
                                <ThemedTextInput type="text" style={{ width: "100%" }} reference={titleRef} error={titleErr} />
                            </div>
                            <div style={{ margin: "0.5vw" }}>
                                Kategorie:
                    ...
                    <Grid2 style={{ marginLeft: "5vw", width: "45%" }} xl={1}>
                        ...
                        <div style={{ margin: "0.5vw" }}>
                            Název obce:
                            <ThemedTextInput type="text" style={{ width: "100%" }} reference={locationNameRef} error={locationNameErr} />
                        </div>
                        <div style={{ margin: "0.5vw" }}>
                            PSČ:
                            <ThemedTextInput type="text" style={{ width: "50%" }} reference={locationZipRef} error={locationZipErr} />
                        </div>
                        <h3>Cena</h3>
                        <div style={{ margin: "0.5vw" }}>
                            Typ inzerce:
