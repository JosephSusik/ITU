...
export default function DiscussionReply(props: any) {
    ...
    return (
        <div className={props.classes.container} style={{marginLeft: "4vw"}}>
            <div>
                {props.comment.author.name + ' ' + props.comment.author.surname} {props.OpId == props.comment.author.id ? <strong> - Prodejce</strong> : ''}
            </div>
